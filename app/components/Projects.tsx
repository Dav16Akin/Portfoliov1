...
function ProjectRow({ project, index }: { project: (typeof projects)[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ paddingLeft: hovered ? "calc(0rem + 8px)" : "0rem", transition: "padding 0.2s ease" }}>
        {/* Row 1: number + title + category */}
        <div style={{ display: "grid", gridTemplateColumns: "3.5rem 1fr auto", gap: "1.5rem", alignItems: "baseline", marginBottom: "1rem" }}>
  ...
  return (
    <section id="projects" className="section" style={{ background: "var(--bg)" }}>
      <div className="container">
        ...
        {/* Header */}
        <div ref={headingRef} style={{ marginBottom: "1rem", display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          <div>
            ...
            <motion.h2
              ...
              className="display"
              style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", color: "var(--fg)" }}
            >
              Projects
            </motion.h2>
          </div>
